...
pub fn login_form() -> Html {
    ...
    let user_login = use_async({
        ...
        async move {
            ...
            request_post::<UserLogin, UserToken>("http://194.58.90.123:9001/login".to_string(), &*data_state.borrow_mut())
                .await
        }
    });
    ...
    let change_phone = {
        ...
        Callback::from(move |event: InputEvent| {
            ...
            (*data.borrow_mut()).phone = input.unwrap().value();
        ...
        <div class="login-form section">
        {
            ...
            <div class="field">
                    <p class="control has-icons-left has-icons-right">
                        <input class="input" name="phone" type="text" oninput={change_phone} placeholder="phone"/>
